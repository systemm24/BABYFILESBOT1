...
async def pm_spoll_choker(msg):
    ...
    await msg.reply("I Cᴏᴜʟᴅɴ'ᴛ Fɪɴᴅ Aɴʏᴛʜɪɴɢ Rᴇʟᴀᴛᴇᴅ Tᴏ Tʜᴀᴛ. Dɪᴅ Yᴏᴜ Mᴇᴀɴ Aɴʏ Oɴᴇ Oғ Tʜᴇsᴇ? Cᴏɴᴛᴀᴄᴛ Aᴅᴍɪɴ Fᴏʀ Yᴏᴜʀ Qᴜᴀʀʏ - @CHATSUPPORTY", reply_markup=InlineKeyboardMarkup(btn), quote=True)
